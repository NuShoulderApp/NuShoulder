...
// INCLUDE BOOTSTRAP 4 COMPONENTS - REACTSTRAP
...
class ApplicationLayoutComponent extends React.Component {
	...
	*/
	...
	render() {
		...
		if(this.props.Account.accountPrefix) {
			logoImage = `${this.props.Account.accountPrefix}_logo.png`;
		}
								...
								<Nav className="mr-auto" navbar>
									<UncontrolledDropdown nav inNavbar setActiveFromChild>
										...
										<DropdownMenu className="bg-white">
											<DropdownItem tag="div"><NavLink onClick={this.toggleTopNav} to={`/accounts`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="warehouse" /> <span className="nav-label">{this.props.translate('Accounts')}</span></NavLink></DropdownItem>
								...
								<Nav className="mr-auto" navbar>
									...
									<UncontrolledDropdown nav inNavbar setActiveFromChild>
										...
										<DropdownMenu className="bg-white">
											...
											<DropdownItem tag="div"><NavLink onClick={this.toggleTopNav} to={`/workflow/list/engraving`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="pen-alt" /> <span className="nav-label">{this.props.translate('In-House Engraving')}</span></NavLink></DropdownItem>
											...
											<DropdownItem tag="div"><NavLink onClick={this.toggleTopNav} to={`/workflow/list/pawprints`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="paw" /> <span className="nav-label">{this.props.translate('Paw Prints / Fur Clipping')}</span></NavLink></DropdownItem>
										</DropdownMenu>
									</UncontrolledDropdown>

									{/* <UncontrolledDropdown nav inNavbar setActiveFromChild>
										<DropdownToggle caret className="mr-3">
											{this.props.translate('Reporting')}
										</DropdownToggle>
										<DropdownMenu className="bg-white">
											<DropdownItem tag="div"><NavLink onClick={this.toggleTopNav} to={`/reporting/employee_activity`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="users" /> <span className="nav-label">{this.props.translate('Employee Activity')}</span></NavLink></DropdownItem>
										</DropdownMenu>
									</UncontrolledDropdown>
 */}
									{/* <UncontrolledDropdown nav inNavbar setActiveFromChild>
									...
									<UncontrolledDropdown nav inNavbar setActiveFromChild>
										<DropdownToggle caret className="mr-3">
											{this.props.translate('Cremations')}
										</DropdownToggle>
										<DropdownMenu className="bg-white">
											<DropdownItem tag="div"><NavLink onClick={this.toggleTopNav} to={`/cremations/cremation_workflow`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="fire" /> <span className="nav-label">{this.props.translate('Cremation Workflow')}</span></NavLink></DropdownItem>
											<DropdownItem tag="div"><NavLink onClick={this.toggleTopNav} to={`/cremations/perform`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="fire" /> <span className="nav-label">{this.props.translate('Perform Cremations')}</span></NavLink></DropdownItem>
											<DropdownItem tag="div"><NavLink onClick={this.toggleTopNav} to={`/cremations`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="fire" /> <span className="nav-label">{this.props.translate('Cremation Logs')}</span></NavLink></DropdownItem>
									...
									<UncontrolledDropdown nav inNavbar setActiveFromChild>
										...
										<DropdownMenu className="bg-white">
											...
											<DropdownItem tag="div"><NavLink to={`/dashboard`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="tachometer-alt" /> <span className="nav-label">{this.props.translate('Dashboard')}</span></NavLink></DropdownItem>
												...
												{/* <DropdownItem tag="div"><NavLink to={`/dashboard_super_admin`} className="nav-link p-0" activeClassName="active"><FontAwesomeIcon icon="tachometer-alt" /> <span className="nav-label">{this.props.translate('Dashboard Super Admin')}</span></NavLink></DropdownItem> */}
											
											<div className="text-center"><Logout/></div>
										</DropdownMenu>
									</UncontrolledDropdown>
								</Nav>
								<div className="float-right"><Link onClick={this.toggleTopNav} to={`/new_orders/create_new/cremation`} className="nav-link btn btn-warning rounded" style={{backgroundColor: '#ec8333', borderColor: '#ec8333'}} active="false"><FontAwesomeIcon icon="paw" className="" /></Link></div>
								<div className="float-right ml-3"><Link onClick={this.toggleTopNav} target="_blank" to={`/orders/phone_call`} className="nav-link btn btn-success rounded" active="false"><FontAwesomeIcon icon="phone" className="" /></Link></div>
							</Collapse>
						</Navbar>
	...
	// VET STAFF
	} else if (this.props.Session.isLoggedIn() === true && this.props.Session.User.userTypeId === "5") {
			const {
				firstName,
				lastName
			} =	this.props.Session.User;
...
const ApplicationLayout = withTranslate(withSession(ApplicationLayoutComponent));
