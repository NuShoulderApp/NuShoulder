...
import { CremationWorkflow } from "../cremations/cremation_workflow";

import { Dashboard } from "../dashboard/dashboard_component";
import { DashboardSuperAdmin } from "../dashboard/dashboard_super_admin";
...
import { OrderPhoneCall } from "../orders/order_phone_call";
...
import { ReportingEmployeeActivity } from "../reporting/employee_activity";
...
function PublicRoutes(Account) {
	...
	return <Switch>
		...
		<Route path="/memorialization" component={ProductsMemorializationRoutes} />

		{/* <Route path="/memorialize" component={PetReferenceCheck} />
		<Route path="/memorials" render={DetailColumn(MemorialRoutes)} />
...
function AppRoutes() {
	return <Switch>
		...
		<Route path="/dashboard_super_admin" component={DashboardSuperAdmin} />
		...
		<Route path="/reporting" render={ReportingRoutes} />
...
const CremationsRoutes = (props) => (
	<React.Fragment>
		...
		<Route exact path={`${props.match.path}/cremation_workflow`} component={CremationWorkflow} />
...
const OrdersRoutes = (props) => (
    <Switch>
		...
		<Route exact path={`${props.match.path}/orderId/:orderId/section/:section`} component={OrderDetails} />
		<Route exact path={`${props.match.path}/phone_call`} component={OrderPhoneCall} />
...
const ReportingRoutes = (props) => (
	<React.Fragment>
		<Route exact path={`${props.match.path}/employee_activity`} component={ReportingEmployeeActivity} />
	</React.Fragment>
)
